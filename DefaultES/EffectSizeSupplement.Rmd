...
Okay, now I can generate data we similar to what we used in the manuscipt. First, let us create the "Interpretatable Raw Differences" example. In this example, we have a pre-to-post design of athletes where we are measuring $\dot{V}O_2$ (L$\cdot$min\textsuperscript{-1}). Further, we assume we are sampling from a population wherein the standard deviation of 0.2, correlation pre/post of .9, and a mean increase of .3 (L$\cdot$min\textsuperscript{-1}).
