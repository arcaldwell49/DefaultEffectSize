...
While it is easy to calculate the SMD or CLES in R, it is quite another thing to calculate their confidence intervals (CI). Unlike the mean difference, the formulae for the CI of the SMD are convoluted (see @hedges1981). Thus, here, we rely on the bootstrap to generate CIs.
...
From these statistics, we can extract the effect size estimate by calling on the `$t0`.
