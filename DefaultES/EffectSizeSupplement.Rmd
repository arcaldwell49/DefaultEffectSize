...
Now, we want to create an "Uninterpretable Raw Differences" dataset. This time we are creating a dummy dataset of VAS scores with 15 'point' reduction and correlation of 0.7. We also have the data generation process come from a log-normal process.
